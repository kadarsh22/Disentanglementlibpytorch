...
class Cars3D(ground_truth_data.GroundTruthData):
	...
	def _load_data(self):
		...
		all_files = [x for x in gfile.ListDirectory('/home/adarsh/Documents/data/cars/') if ".mat" in x]
...
def _load_mesh(filename):
	...
	with gfile.Open(os.path.join('/home/adarsh/Documents/data/cars/', filename), "rb") as f:
