...
class Trainer(object):
    ...
    def train_gan(self, model, optimizer, epoch):
        ...
        for iter, images in enumerate(self.train_loader):
            ...
            G_loss = g_loss + cont_loss * 0.1 +  oracle_orient_loss + oracle_size_loss + oracle_xpos_loss + oracle_ypos_loss+\
                     oracle_size_genloss + oracle_orient_genloss + oracle_xpos_genloss + oracle_ypos_genloss +oracle_shape_loss +oracle_shape_genloss
            ...
            d_loss_summary = d_loss_summary + loss_fake.item()
